!(function(t) {
  ...
  function(t, e, n) {
    ...
    var T,
      O =
        "resize.chandaHealix orientationchange.chandaHealix load.chandaHealix";
    function b(t, e) {
      var n = [],
        r = {};
      return (
    ...
    (r.resize = b(c, O)),
      (r.scroll = b(
        c,
        "scroll.chandaHealix resize.chandaHealix orientationchange.chandaHealix load.chandaHealix"
      )),
      (r.redraw = b()),
  ...
  function(t, e, n) {
    ...
    e.viewportWidthChanged = function(t) {
      var e = t.width,
        n = t.mediaQueries;
      return { type: b, payload: { width: e, mediaQueries: n } };
    };
  ...
  function(t, e, n) {
    ...
    window.tram = (function(t) {
      ...
      if (C.transition) {
        var N = C.timing.dom;
        if (((A.style[N] = l["ease-in-back"][0]), !A.style[N]))
  ...
  function(t, e, n) {
    ...
    var a = o(n(26)),
      ...
      rt = 12;
    function it(t, e) {
      ft({ store: e, rawData: t.rawData, allowEvents: !0 }), ot();
    }
    function ot() {
    ...
    function ut(t, e) {
      ...
      if (
        ...
        ft({ store: e, rawData: f, allowEvents: a }),
        (r && n === N) || at(n))
      ) {
        yt({ store: e, actionListId: r }),
          _t({ store: e, actionListId: r, eventId: o });
        var l = It({
          store: e,
          eventId: o,
          actionListId: r,
    ...
    function ct(t, e) {
      ...
      n ? yt({ store: e, actionListId: n }) : mt({ store: e }), lt(e);
    }
    function st(t, e) {
      lt(e), U({ store: e, elementApi: y });
    }
    function ft(t) {
      var e,
        n = t.store,
                    ...
                    ? (function(t) {
                        ...
                        if ((0, f.default)(d)) {
                          (0, v.default)(d, function(t, e) {
                            ...
                            (a.actionTypeId === N || at(a.actionTypeId)) &&
                              _t({ store: n, actionListId: v, eventId: f });
                          });
                          var p = function(t) {
                              var e = n.getState(),
                                r = e.ixSession;
          ...
          (function(t) {
            !(function e(n) {
              var r = t.getState(),
                ...
                o = r.ixParameters;
              i.active &&
                (t.dispatch((0, m.animationFrameChanged)(n, o)),
    ...
    function lt(t) {
      ...
      e.active &&
        (e.eventListeners.forEach(dt), t.dispatch((0, m.sessionStopped)()));
    }
    function dt(t) {
      var e = t.target,
        n = t.listenerParams;
    ...
    function It(t) {
      ...
      u >= _.length && (0, s.default)(v, "config.loop") && (u = 0),
        0 === u && m && u++;
      var I =
          (0 === u || (1 === u && m)) && at(v.action && v.action.actionTypeId)
            ? v.config.delay
            : void 0,
    ...
    function Tt(t) {
      ...
      e.dispatch(
        (0, m.instanceAdded)(
          (0, a.default)(
            { instanceId: l, elementId: p, origin: E, refType: h },
            r
          )
        )
      ),
        ...
        s
          ? (function(t, e) {
              ...
              t.dispatch(
                (0, m.animationFrameChanged)(Number.POSITIVE_INFINITY, n)
              ),
          ...
          : (G({
            ...
            i && e.dispatch((0, m.instanceStarted)(l)));
    }
    function Ot(t, e) {
      ...
      (t.exports = function(t) {
        ...
        return (
          (n.ready = function() {
            ...
            /\.chandaHealix\.io$/i.test(p) && c.hostname !== p && (u = !0),
              u &&
                !s &&
                ((e =
                  e ||
                  ((n = t('<a class=""></a>').attr("href", "")),
                  (r = t("<img>")
                    .attr("src", "")
                    .css()),
                  (a = t("<img>").attr("src", "")),
  ...
  function(t, e, n) {
    ...
    var r = window.$,
      i = n(55) && r.tram;
    /*!
     * Healix._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
      ...
      (t.exports = function(t, e, n) {
        ...
        try {
          f =
            ...
            localStorage.getItem("siteEditor");
        } catch (t) {}
        function l() {
      ...
      (t.exports = function(t, e) {
        ...
        function T() {
          !(function() {
            ...
            e.each(w),
              e.each(O),
              E.length && (r.scroll.on(S), setTimeout(S, 1));
            g.length && r.load(A);
  ...
  function(t, e, n) {
    ...
    e.createPluginInstance = function(t) {
      var e = window.Healix.require("lottie").createInstance(t);
  ...
  function(t, e, n) {
        ...
        switch (i) {
          ...
          case y.STYLE_TEXT_COLOR:
            var b = n.config,
              ...
              A = b.bValue,
              R = b.aValue;
            return { rValue: w, gValue: S, bValue: A, aValue: R };
          case y.STYLE_FILTER:
    ...
    function L(t) {
      ...
      var R,
        ...
        D = Boolean(N.id || N.selector),
        P = n && u(x(n.target));
      if (
        (D
          ? ((R = N.limitAffectedElements), (L = P), (C = u(N)))
          : (L = C = u({ id: g, selector: T, selectorGuids: O })),
        n && S)
      ) {
        var M = r && (C || !0 === S) ? [r] : c(P);
        if (C) {
      ...
      switch (e.type) {
        ...
        case l:
          var g = e.payload,
            _ = g.actionListId,
            m = g.isPlaying;
          return (0, i.setIn)(t, ["playbackState", _], m);
        case d:
          for (
            var y = e.payload,
              I = y.width,
          ...
          return (0, i.merge)(t, { viewportWidth: I, mediaQueryKey: b });
        case p:
      ...
      y = function(t, e) {
        ...
        for (var b = 0, w = o.length; b < w; b++) {
          ...
          if ((0 === b && (h = R[0]), O >= A)) {
            ...
            var x = o[b + 1],
              L = x && O !== A;
            (E = L ? x.actionItems[0] : null),
              L && ((_ = A / 100), (m = (x.keyframe - A) / 100));
          }
        }
        var C = {};
        if (h && !E)
    ...
    e.ixInstances = function() {
      ...
      switch (e.type) {
        ...
        case f:
          ...
          if (!t[X]) return t;
          for (
            var V = {}, U = Object.keys(t), k = U.length, B = 0;
            B < k;
            B++
          ) {
            var W = U[B];
  ...
  function(t, e, n) {
    ...
    var c,
      ...
      mt =
        ...
        (0, o.default)(r, S, Et()),
        (0, o.default)(r, w, gt()),
        (0, o.default)(r, N, Et(!1)),
        (0, o.default)(r, C, gt(!1)),
        (0, o.default)(r, x, Et()),
        (0, o.default)(r, L, gt()),
        (0, o.default)(r, B, {
        ...
        (0, o.default)(r, I, (0, l.default)({}, it, { types: "mousedown" })),
        (0, o.default)(r, T, (0, l.default)({}, it, { types: "mouseup" })),
        (0, o.default)(r, O, {
        ...
        (0, o.default)(r, D, {
          ...
          handler: function(t) {
            ...
            switch (u) {
              ...
              case K:
                var A = st(),
                  ...
                  L = A.scrollWidth,
                  C = A.scrollHeight;
                b = T ? Math.min(R + m, L) / L : Math.min(x + I, C) / C;
                break;
              case Y:
              default:
                w = q(o, s);
                var N = 0 === i.type.indexOf("mouse");
                if (N && !0 !== tt({ element: n, nativeEvent: i })) break;
            ...
            return (
              ...
              (u !== Y || S || S !== a.elementHovered) &&
                ((b = f ? 1 - b : b),
                e.dispatch((0, E.parameterChanged)(w, b))),
              { elementHovered: S, clientX: v, clientY: g, pageX: m, pageY: I }
            );
          }
        }),
        (0, o.default)(r, H, {
        ...
        (0, o.default)(r, V, {
          ...
          handler: function(t) {
            ...
            var x = S.top + Math.min(S.height * A, l),
              L = S.top + S.height * R - x,
              C = Math.min(l + L, f),
              N = Math.min(Math.max(0, l - x), C) / C;
            return (
              N !== o.scrollPercent &&
                n.dispatch((0, E.parameterChanged)(w, N)),
              { scrollPercent: N }
            );
          }
        }),
    ...
    function s(t, e, n, r) {
      ...
      function E(t, e) {
        return (
          ...
          (function(t) {
            ...
            C(s.content, "group")),
          l(N(s.lightbox, "hide").trigger("focus"))
            .add("opacity .3s")
            .start({ opacity: 1 }),
          C(s.html, "noscroll"),
          E.show(e || 0)
      ...
      (E.build = function() {
        return (
          ...
          s.strip.on("tap", L("item"), I),
          s.content
            .on("swipe", T)
            .on("tap", L("left"), _)
            .on("tap", L("right"), m)
            .on("tap", L("close"), y)
            .on("tap", L("image, caption"), m),
          s.container.on("tap", L("view"), y).on("dragstart", L("img"), b),
        ...
        (E.destroy = function() {
          s && (N(s.html, "noscroll"), s.lightbox.remove(), (s = void 0));
        }),
        (E.show = function(t) {
          if (t !== o) {
            var e = h[t];
    ...
    r.define(
      ...
      (t.exports = function(t, e) {
        ...
        function R(e, n) {
          ...
          if ((!r.open || i || a || N(r, !0), r.container.length)) {
            var o = (function(e) {
...
/**
 * ----------------------------------------------------------------------
 * Healix: Interactions: Init
 */
Healix.require("ix").init([
  {
    slug: "scroll-down-line",
    name: "scroll down line",
    value: {
      style: {},
      triggers: [
        {
          ...
          stepsA: [
            {
              opacity: 1,
              transition: "transform 800ms ease 0, opacity 800ms ease 0",
              x: "0px",
              y: "0vh",
              z: "0px"
            }
  ...
  {
    slug: "cherry-bg-scroll",
    name: "cherry bg scroll",
    value: {
      style: {},
      triggers: [
        {
          type: "scroll",
          selector: ".intro-bg-line",
          offsetTop: "50%",
          offsetBot: "50%",
          preserve3d: true,
          stepsA: [
  ...
  {
    slug: "cherry-bg-scroll-2",
    name: "cherry bg scroll 2",
    value: {
      style: {},
      triggers: [
        {
          type: "scroll",
          selector: ".cherry-bg-line",
          offsetTop: "50%",
          offsetBot: "50%",
          preserve3d: true,
          stepsA: [
  ...
  {
    slug: "cherry-bg-line-init",
    name: "cherry bg line init",
    value: {
      style: {
        opacity: 0,
        x: "50%",
  ...
  },
  {
    ...
    value: {
      ...
      triggers: [
        {
          type: "hover",
          selector: ".sports-content-1",
          stepsA: [{ opacity: 0, transition: "opacity 200 ease 0" }],
          stepsB: [{ opacity: 1, transition: "opacity 200 ease 0" }]
        },
        {
          type: "hover",
          selector: ".sports-content-2",
          stepsA: [{ opacity: 1, transition: "opacity 200 ease 0" }],
          stepsB: [{ opacity: 0, transition: "opacity 200 ease 0" }]
        },
        {
          type: "hover",
          selector: ".sports-content-3",
          stepsA: [{ opacity: 0, transition: "opacity 200 ease 0" }],
          stepsB: [{ opacity: 0, transition: "opacity 200 ease 0" }]
        },
        {
          type: "hover",
          selector: ".sports-content-4",
          stepsA: [{ opacity: 0, transition: "opacity 200 ease 0" }],
          stepsB: [{ opacity: 0, transition: "opacity 200 ease 0" }]
        }
      ]
      ...
      triggers: [
        {
          ...
          stepsA: [
            {
              opacity: 1,
              transition: "opacity 800ms ease 0, transform 800ms ease 0",
              x: "0px",
              y: "0px",
              z: "0px"
            }
  ...
  {
    slug: "contact-button-init",
    name: "contact button init",
    value: {
...
/**
 * ----------------------------------------------------------------------
 * Healix: Interactions 2.0: Init
 */
Healix.require("ix2").init({
  events: {
    "e-4": {
      id: "e-4",
      ...
      action: {
        ...
        config: {
          actionListId: "a-9",
          affectedElements: {
            "chandaHealix|a0cbb742-b06f-ab94-d6a8-16f57cd8999f": {
              selector: ".hero-bottle",
              selectorGuids: ["95969077-2ccf-786b-6415-517f2019a0aa"],
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|a0cbb742-b06f-ab94-d6a8-16f57cd8999f"
      },
      config: [
        {
    ...
    "e-7": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|a0cbb742-b06f-ab94-d6a8-16f57cd8999f": {
              selector: ".egg-overlay-pc",
              selectorGuids: ["a39caac3-4fc8-1c2c-75ad-b51fce6c9878"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-8": {
      ...
      action: {
        ...
        config: {
          actionListId: "a-12",
          affectedElements: {
            "chandaHealix|e5f79231-45f7-12b9-ae73-f9f53f508503": {
              selector: ".cherry-bg",
              selectorGuids: ["f5995072-5081-320b-0cc5-fe31b37f2e88"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|e5f79231-45f7-12b9-ae73-f9f53f508503"
      },
      config: [
        {
    ...
    "e-9": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|e5f79231-45f7-12b9-ae73-f9f53f508503": {
              selector: ".cherry-bg-circle",
              selectorGuids: ["ebe92016-9a38-84ce-d809-8a85507bfbe7"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-10": {
      ...
      action: {
        ...
        config: {
          actionListId: "a-14",
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".chemical-card",
              selectorGuids: ["5226df81-a895-33df-c68a-9b13a401839c"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534"
      },
      config: [
        {
    ...
    "e-11": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".benefits-bg",
              selectorGuids: ["4a38bac5-9324-268a-a2e2-5de04c49ca87"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-12": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".chemical-line",
              selectorGuids: ["349c0e4b-9b88-2abc-66b6-e086e1701ca7"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".left-arrow",
              selectorGuids: ["23a0c76f-6d0c-c6af-4462-d5ae92844b1d"],
              limitAffectedElements: null
            }
          },
          duration: 0
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              ...
              selectorGuids: ["a556b3b9-9606-f548-ccca-0237ed861a9b"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".slide-nav",
              selectorGuids: ["d602aba4-0fbd-6018-af00-b60f5fe691a0"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-16": {
      ...
      action: {
        ...
        config: {
          actionListId: "a-17",
          affectedElements: {
            "chandaHealix|46272565-11a5-ac9f-1b67-6146d0bde299": {
              selector: ".origin-bg",
              selectorGuids: ["c2abc3f0-7c6a-11a6-1168-44ee0ec06c84"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|46272565-11a5-ac9f-1b67-6146d0bde299"
      },
      config: [
        {
    ...
    "e-17": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|46272565-11a5-ac9f-1b67-6146d0bde299": {
              selector: ".origin-video-lightbox",
              selectorGuids: ["b281e9ea-542c-b79f-7b90-57ca22408d96"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-22": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|e5f79231-45f7-12b9-ae73-f9f53f508503": {
              selector: ".intro-bg",
              selectorGuids: ["69141ef8-a46c-f665-38c5-ea3c23a5fe99"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|5b51568d-ce2e-5935-b518-40529acbfeab"
      },
      config: [
        {
          continuousParameterGroupId: "a-12-p",
    ...
    "e-23": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|e5f79231-45f7-12b9-ae73-f9f53f508503": {
              selector: ".intro-bg-circle",
              selectorGuids: ["40ae2eeb-a659-f144-cb92-63fec6051ffe"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-24": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".fans-bg",
              selectorGuids: ["f84a1b7b-1413-ad55-b87d-817aa0a351ca"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|9f2be280-2c60-8c95-eab4-78c7cd5c0eb1"
      },
      config: [
        {
    ...
    "e-25": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".sports-pics-wrapper",
              selectorGuids: ["bc41c552-2312-6261-d0bc-bee55342a2f7"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-26": {
      ...
      action: {
        ...
        config: {
          actionListId: "a-20",
          affectedElements: {
            "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68": {
              selector: ".hero-bottle",
              selectorGuids: ["95969077-2ccf-786b-6415-517f2019a0aa"],
              limitAffectedElements: null
            }
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68"
      },
      config: [
        {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68": {
              ...
              selectorGuids: ["8556f1d1-91f2-e45b-db24-cea9d049b7b6"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-28": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68": {
              selector: ".hero-slogan-mobile",
              selectorGuids: ["eccd075f-10bf-4236-317b-2238eb55443e"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-29": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68": {
              selector: ".hero-title-line",
              selectorGuids: ["9fd3868e-2d41-c33b-179e-3f451844409d"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|99cd4013-0189-b02f-ea26-ee20d28ead68": {
              selector: ".hero-desc",
              selectorGuids: ["1e6ba229-4d61-0d86-1209-8c79191ab29e"],
              limitAffectedElements: null
            }
          },
          duration: 0
    ...
    "e-31": {
      ...
      action: {
        ...
        config: {
          ...
          affectedElements: {
            "chandaHealix|5e9ebae2-fbda-8e91-a0e9-791f24b65534": {
              selector: ".chemical-button",
              selectorGuids: ["219b415b-bfa4-6d61-6058-ba8b70dc2e70"],
              limitAffectedElements: null
            }
          },
          duration: 0
      ...
      createdOn: 1515346493684
    }
  },
  actionLists: {
    "a-9": {
      id: "a-9",
      title: "move hero bottle",
    ...
    "a-11": {
      ...
      createdOn: 1513333082976
    },
    "a-12": {
      id: "a-12",
      title: "cherry move in",
      continuousParameterGroups: [
        {
          id: "a-12-p",
          type: "SCROLL_PROGRESS",
      ...
      createdOn: 1513376552956
    },
    "a-13": {
      id: "a-13",
      title: "cherry circle move in",
      continuousParameterGroups: [
        {
          id: "a-13-p",
          type: "SCROLL_PROGRESS",
      ...
      createdOn: 1513376721850
    },
    "a-14": {
      id: "a-14",
      title: "chemical card move in",
      continuousParameterGroups: [
        {
          id: "a-14-p",
          type: "SCROLL_PROGRESS",
